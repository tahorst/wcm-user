...
ANALYSIS = [
    ...
    (2, 'f', True, COMBINATIONS, 'Variant', 'growth_trajectory', '', '--generation-path-range 6 25', '', []),
    (2, 'f', True, ADD_ONE, 'Variant', 'growth_trajectory', '', '--generation-path-range 2 16', '', []),
    (2, 'f', True, REMOVE_ONE, 'Variant', 'growth_trajectory', '', '--generation-path-range 4 8', '', []),
    (2, 'f', True, CONDITIONS_NO_REG, 'Variant', 'growth_trajectory', '', '', '', []),
    (2, 'f', True, CONDITIONS, 'Variant', 'growth_trajectory', '', '', '', []),
    (2, 'f', False, PAPER_DIR, 'growth_rp_plot.py', '', '', '', '', ['groups-combined-growth-rp']),
    (2, 'g', True, DOWN_UP, 'Parca', 'aa_synthesis_pathways', '', '', 'kb_plot_out', ['']),
    (2, 'h', True, DOWN_UP, 'Parca', 'amino_acid_uptake_rates', '', '', 'kb_plot_out', ['_clean']),
