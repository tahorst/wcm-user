...
ANALYSIS = [
    ...
    (5, 'a', True, DOWN_UP, 'Cohort', 'growth_time_series', '', '', 'timelines_000027/plotOut', ['_fig5']),
    ...
    (5, 'c', True, DOWN_UP_NO_PPGPP, 'Cohort', 'growth_time_series', '', '', 'timelines_000027/plotOut', ['_fig5']),
